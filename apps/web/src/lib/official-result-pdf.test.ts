...
function officialResult(): OfficialResult {
  return {
    ...
    approvals: [
      ...
      { stage: 'FACULTY', scopeKey: '32345678-1234-1234-1234-123456789abc', label: 'CS405', approved: true, approverName: 'Dr. Sameer Iyer', approverRole: 'FACULTY', approvedAt: '2026-06-15T09:05:00.000Z', comment: null },
    ...
    publication: {
      ...
      verificationUrl: 'https://campus.example.edu/verify/result/12345678-1234-1234-1234-123456789abc.ABCDEFGHIJKLMNOPQRSTUVWXYZA',
      integrity: 'VERIFIED',
    },
  };
}
