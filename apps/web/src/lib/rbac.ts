...
export const ROLE_PERMISSIONS: Record<RoleType, Permission[]> = {
  SUPER_ADMIN: [
    ...
    'view_academic_records', 'edit_academic_records', 'manage_finance', 
    'manage_hostel', 'manage_library', 'manage_transport', 'impersonate_user'
  ],
  INSTITUTION_ADMIN: [
  ...
  PLACEMENT_OFFICER: [
    'view_dashboard' // + placement specific
  ],
