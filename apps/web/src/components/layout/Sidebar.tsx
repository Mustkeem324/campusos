  ...
  return (
    <>
      {isMobileOpen && (
        <button
          type="button"
          className="fixed inset-0 z-[65] bg-[#101D38]/55 md:hidden"
      ...
      <aside
        className={`app-sidebar fixed left-0 flex flex-col border-r border-[#DDE5EF] bg-white shadow-[8px_0_28px_rgba(16,29,56,0.035)] transition-[width,transform] duration-300 dark:border-slate-800 dark:bg-slate-950 max-md:-translate-x-full ${
