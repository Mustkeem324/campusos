...
export default async function Page() { const region = ((await cookies()).get('campus_region')?.value || 'us') as Region; return <PublicPage segments={["platform","communication"]} region={region} />; }
