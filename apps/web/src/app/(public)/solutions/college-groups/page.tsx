...
export default function Page() { const region = (cookies().get('campus_region')?.value || 'us') as Region; return <PublicPage segments={["solutions","college-groups"]} region={region} />; }
