...
export default function Page() { const region = (cookies().get('campus_region')?.value || 'us') as Region; return <PublicPage segments={["solutions","autonomous-colleges"]} region={region} />; }
